...
public class KaptchaConfig {
    ...
    public DefaultKaptcha getKaptchaBeanMath()
    {
        ...
        properties.setProperty(KAPTCHA_BORDER, "no");
        // 边框颜色 默认为Color.BLACK
        properties.setProperty(KAPTCHA_BORDER_COLOR, "11,118,184");
        // 验证码文本字符颜色 默认为Color.BLACK
        properties.setProperty(KAPTCHA_TEXTPRODUCER_FONT_COLOR, "29,161,242");
        // 验证码图片宽度 默认为200
        ...
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "cn.sky1998.mongo.framework.config.KaptchaTextCreator");
        // 验证码文本字符间距 默认为2
